...
//        System.out.println(mag);
        switch (MagazineName.valueOf(mag)) {
            case 上海财经大学学报:
            magazine=new JournalofShanghaiUniversityofFinanceandEconomics();
            ...
            case 金融与经济://只处理09年及以后的 且摘要为空
                ...
                break;
            case 南方金融:
                magazine=new SouthFinance();
                ExtractFromDifMagazines.extract(magazine,file,writeCSV);
                break;

            case 武汉金融:
                magazine=new WuhanFinance();
                ExtractFromDifMagazines.extract(magazine,file,writeCSV);
                break;

            case 贵州财经大学学报:
                magazine=new GuizhouFinanceUniversity();
                ExtractFromDifMagazines.extract(magazine,file,writeCSV);
                break;
            // ***************************************************
            case 金融理论探索:
                magazine=new Explorationoffinancialtheory();
                ExtractFromDifMagazines.extract(magazine,file,writeCSV);
                break;
            case 哈尔滨商业大学学报:
